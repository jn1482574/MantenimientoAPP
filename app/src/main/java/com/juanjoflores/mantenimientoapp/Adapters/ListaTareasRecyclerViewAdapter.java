...
public class ListaTareasRecyclerViewAdapter extends RecyclerView.Adapter<ListaTareasRecyclerViewAdapter.ViewHolder>{
    ...
    public ListaTareasRecyclerViewAdapter(Context context, Fragment fragment, Animation animationUp, Animation animationDown, List<TareasAsignadas> listTareas) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tvTipo.setText("Tipo de Tarea: "+listTareas.get(position).getTipo_tarea().getTarea() + "\nDuracion: "+listTareas.get(position).getDuracion()+" min");
